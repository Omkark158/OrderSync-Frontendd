          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="relative z-10">
                <div className={`${step.color} text-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg`}>
                  {step.number}
                </div>
                <step.icon className="w-16 h-16 text-gray-800 mx-auto mb-6" />
